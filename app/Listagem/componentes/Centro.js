...
this.niveis = [
 ...
 render() {
	...
	var lista = this.niveis.map(function(nivel, key) {
		...
		var state = {origin: styles.hidden, button: styles.back_button};
	...
	return (
		<View>  
			...
			<TouchableOpacity style = {this.state.button}
				onPress ={() => {
			...
			{/*<Image style = {styles.back_arrow}
				...
				resizeMode = "stretch" />*/}
				<Text style = {styles.back_arrow}>VOLTAR PARA LISTA DE CLIENTES</Text>
			</TouchableOpacity>
			{/*</View>*/}
